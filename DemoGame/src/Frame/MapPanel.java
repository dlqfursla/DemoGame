...
public class MapPanel extends BasePanel {
   ...
   public JLabel getToMap1Label(int i) {
      return Map1Label[i];
   }

   public JLabel getToMap2Label(int i) {
      return Map2Label[i];
   }

   public JLabel getToMap3Label(int i) {
      return Map3Label[i];
   }

   public JLabel getToMap4Label(int i) {
      return Map4Label[i];
   }

   public JLabel getToMap5Label(int i) {
      return Map5Label[i];
   }

   public JLabel getToMap6Label(int i) {
      return Map6Label[i];
   }
   ...
   private void initMapPanel() {
      ...
      Map6Pnl.setBounds(750, 350, 350, 350);
      add(Map6Pnl);
